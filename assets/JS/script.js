...
button.addEventListener('click', () => {
    ...
    if (clickCount < 12) {
        ...
        const audio = new Audio('../sounds/wedbell.mp3');
        audio.play();
    } else if (clickCount === 12) {
        // After 12 clicks, replace the background and play 'wedding.mp4'
        container.style.background = 'url("../images/church.jpg") center/cover no-repeat fixed';
        container.innerHTML = '<video id="_video" width="100%" height="100%" controls autoplay><source src="../video/wedding.mp4" type="video/mp4"></video>';
    }
